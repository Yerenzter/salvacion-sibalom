export default function GenerateCutting(fullname, property) {
  ...
  doc.pipe(
    fs.createWriteStream(
      `/home/yerenzter/Documents/[CERT. OF CUTTING] ${fullname}-${dateStamp}.pdf`
    )
  );
  ...
  doc
    ...
    .fontSize(18)
    .text(
      `This is to certify that ${fullname} a resident of Barangay Salvacion, Sibalom, Antique is the owner of ${property} located at Barangay Salvacion, Sibalom, Antique`
    )
    .text(
      "This certification is being issued upon the request of the above stated name for any revocation if found illegal and prejudicial to community interest."
    );
