export default function GenerateClearance(fullname, age, sex) {
  ...
  doc.pipe(
    fs.createWriteStream(
      `/home/yerenzter/Documents/[BRGY. CLEARANCE] ${fullname}-${dateStamp}.pdf`
    )
  );
  ...
  doc
    ...
    .fontSize(18)
    .text(
      `This is to certify that according to the records kept and filed in this barangay ${fullname}, ${age}, ${sex} , years old, and a resident of Salvacion, Sibalom, Antique has no derogatory and/or criminal records. He/She is known to be of good moral character and can be trusted. He/She has never been involve in any unlaw activities`
    )
    .text(
